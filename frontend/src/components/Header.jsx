...
const Header = () => {
  return (
    <div className='flex flex-col justify-between items-center text-cnter my-20'>
      ...
      <h1 className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-[590px] mx-auto mt-10 text-center drop-shadow-lg'>Turn text to <span className='text-blue-500'>image</span>,in seconds</h1>
